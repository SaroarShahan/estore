...
class AuthController extends BaseController {
  ...
  async register(req, res, next) {
    try {
      ...
      logger.info({ message: 'Register Req Body', context: loggerContexts.register, data: req.body });
  ...
  async login(req, res, next) {
    try {
      ...
      logger.info({ message: 'Login Req Body', context: loggerContexts.login, data: { email: req.body.email } });
